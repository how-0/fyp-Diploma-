...
?>
    <div class="panel-1">
        <table class="table title1">
            <div>
			<h3 style="display: inline-block; margin-right: 10px;">Daily Quiz Suggestion</h3>
			<button onclick="window.location.reload();" style="display: inline-block;">Refresh</button>
			</div>
            <tr>
                <th style="text-align: center; width:100px;">Quiz</th>
                <th style="text-align: center; width:100px;">Category</th>
                <th style="text-align: center; width:100px;">Number of Questions</th>
                <th style="text-align: center; width:100px;">Total Marks</th>
