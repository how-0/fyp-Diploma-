...
if($sn == 1)
{
$q=mysqli_query($con,"INSERT INTO history VALUES('$email','$e_id' ,'0','0','0','0',NOW())")or die('Error');
}
...
if($sn == 1)
{
$q=mysqli_query($con,"INSERT INTO history VALUES('$email','$e_id' ,'0','0','0','0',NOW() )")or die('Error137');
}
